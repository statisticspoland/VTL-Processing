namespace StatisticsPoland.VtlProcessing.Core.Tests.Operators
{
    ...
    public class IfThenElseOperatorTests
    {
        ...
        public IfThenElseOperatorTests()
        {
            ...
            opResolverMock.Setup(o => o("if-then-else")).Returns(() => { return new IfThenElseOperator(joinApplyMeasuresOpMock.Object, ModelResolvers.DsResolver); });

            this.opResolver = opResolverMock.Object;

            this.ifThenElseExpr = ModelResolvers.ExprResolver();
            this.ifThenElseExpr.OperatorDefinition = this.opResolver("if-then-else");
