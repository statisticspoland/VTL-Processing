namespace VtlProcessing.IntegrationTests.TSQL.Operators.ReferenceManualExamples.GeneralPurpose
{
    ...
    public class PersistentAssignment : TSQLTestBase
    {
        public PersistentAssignment() : base("Persistent_Assignment")
        {
            ...
            this.SqlFillData("[Persistent_assignment].DS_1", ds1);
        }
        ...
        public void Example1()
        {
            ...
            DataTable ds_r = this.RunSql(sql, "[Persistent_Assignment].DS_r");
