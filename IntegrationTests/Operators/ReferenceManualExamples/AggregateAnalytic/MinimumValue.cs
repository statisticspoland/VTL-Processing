namespace VtlProcessing.IntegrationTests.TSQL.Operators.ReferenceManualExamples.AggregateAnalytic
{
    ...
    public class MinimumValue : TSQLTestBase
    {
        public MinimumValue() : base("Minimum_value")
        {
            ...
            this.SqlFillData("[Minimum_value].DS_1", ds1);
        }
        ...
        public void Example1()
        {
            ...
            string source = "DS_r := min(DS_1 group by Id_1)";
