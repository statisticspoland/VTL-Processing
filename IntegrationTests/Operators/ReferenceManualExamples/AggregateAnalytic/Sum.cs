namespace VtlProcessing.IntegrationTests.TSQL.Operators.ReferenceManualExamples.AggregateAnalytic
{
    ...
    public class Sum : TSQLTestBase
    {
        ...
        public void Example1()
        {
            ...
            expected.LoadDataRow(new object[] { 2011, 15 }, false);
            expected.LoadDataRow(new object[] { 2012, 6 }, false);

            string source = "DS_r := sum(DS_1 group by Id_1)";
