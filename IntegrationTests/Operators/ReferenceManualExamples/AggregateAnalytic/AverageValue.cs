namespace VtlProcessing.IntegrationTests.TSQL.Operators.ReferenceManualExamples.AggregateAnalytic
{
    ...
    public class AverageValue : TSQLTestBase
    {
        public AverageValue() : base("Average_value")
        {
            ...
            this.SqlFillData("[Average_value].DS_1", ds1);
        }
        ...
        public void Example1()
        {
            ...
            expected.LoadDataRow(new object[] { 2011, 5 }, false);
            expected.LoadDataRow(new object[] { 2012, 3 }, false);

            string source = "DS_r := avg(DS_1 group by Id_1)";
